package no.nav.foreldrepenger.fpwsproxy.tilbakekreving.kravgrunnlag;
...
import no.nav.foreldrepenger.fpwsproxy.simulering.util.TestJsonMapper;
import no.nav.foreldrepenger.fpwsproxy.tilbakekreving.kravgrunnlag.request.HentKravgrunnlagDetaljDto;
import no.nav.foreldrepenger.fpwsproxy.tilbakekreving.kravgrunnlag.request.KodeAksjon;
