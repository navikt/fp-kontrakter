...
public class ForeldrepengerOpphoert extends Innhold {

	public ForeldrepengerOpphoert() {
		super();
	}
	
	private ForeldrepengerOpphoert(Builder builder) {
