...
public record Beregningsgrunnlag(@NotNull LocalDate skjæringsTidspunkt, @NotNull List<@Valid BeregningsAndel> beregningsAndeler, @NotNull List<@Valid BeregningAktivitetStatus> beregningAktivitetStatuser) {
    ...
    public record Arbeidsforhold(@NotNull String arbeidsgiverIdent, @Min(0) @Digits(integer = 10, fraction = 2) BigDecimal refusjonPrMnd) {}
